...
const About: Page = {
    ...
    content: [
        ...
        },
        {
            ...
            content: [
                `Like many programmers that grew up in the 90s, I got my start with simple websites and css.
        ...
        },
        {
            header: "The Bootcamp",
            content: [
                `After several prototypes, I finally released a real game on iOS and Android. 
        ...
        },
        {
            ...
            content: [
                `Immediately after the bootcamp, 
