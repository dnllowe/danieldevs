    ...
    content: [
        {
            header: 'Overview',
            content: [
                `SOSeo analyzes content written in its editor to ensure the content follows
        ...
        },
        {
            ...
            content: [
                `I used React + Redux on the frontend. React has become my goto framework for
        ...
        },
        {
            ...
            content: [
                `The application requires standard CRUD operations for users and their content. 
        ...
        },
        {
            ...
            content: [
                `SOSeo was the first time I used typescript. The application began in javascript, but
        ...
        },
        {
            ...
            content: [
                `I used Bootstrap's column and row pattern to control how the site looked at 
        ...
        },
        {
            ...
            content: [
                `SOSeo is a feature-rich application. There are payment plans enabled through
        ...
        },
        {
            ...
            content: [
                `The user's core interface with SOSeo is writing content. 
        ...
        },
        {
            ...
            content: [
                `I used chai and enzyme for unit testing. It's always good to have unit tests,
