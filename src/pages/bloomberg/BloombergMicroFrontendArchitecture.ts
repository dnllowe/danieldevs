    ...
    content: [
        {
            header: 'Overview',
            content: [
                `One of this first big projects I worked on at Bloomberg was a new micro-frontend architecture.
        ...
        },
        {
            ...
            content: [
                `I knew I wanted the developer experience to be frictionless. No one would use the new architecture
        ...
        },
        {
            ...
            content: [
                `The deployment process continues to focus on the fundamentals. The developer is tasked with having a build system
        ...
        },
        {
            ...
            content: [
                `Publishing the assets to blob storage was half the battle. The next step was controlling what to deploy and when.
        ...
        },
        {
            ...
            content: [
                `The final result is a web server that is only aware of the static assets its hosting.
