    ...
    content: [
        {
            header: "Overview",
            content: [
                `I have 1000s of bookmarks. I know because when I used Tag to import them into the app, I got a count. In my defense, I have been bookmarking pages for close
        ...
        },
        {
            ...
            content: [
                `Tag is created as a Svelte app with a node backend persisting data to a Mongo DB database. The app is deployed as a Chrome extension, which surprisingly works by simply dumping
        ...
        },
        {
            header: "Moving On",
            content: [
                `Ultimately, I got Tag to an working state and dog-fooded it for a while. However, after realizing that Chrome extensions don't work on mobile,
