...
const WebBannerPro: Page = {
    ...
    content: [
        {
            header: "Overview",
            content: `Web Banner Pro is a web application that lets users create animated web banners using a drag and drop interface combined with easing between keyframes.
