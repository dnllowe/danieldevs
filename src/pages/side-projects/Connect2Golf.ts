...
const Connect2Golf: Page = {
    ...
    content: [
        {
            header: "Overview",
            content: `My brother loves playing golf. However, courses typically require that players play in groups of 2-4 players.
        ...
        {
            header: "How It Works",
            content: `Players create a profile that lists their skill level, location, availability, favorite courses, and preferences, such as
