    ...
    content: [
        {
            header: "Overview",
            content: [
                `Maia is a no-code platform for training, deploying, and sharing AI / ML models.
        ...
        },
        {
            ...
            content: [
                `Users could import data in a variety of ways from the frontend. Regardless of the source,
        ...
        },
        {
            ...
            content: [
                `With the data uploaded to Maia's backend and a schema provided during import, I could now run basic analytics on the data for the user.
        ...
        },
        {
            ...
            content: [
                `At a high level, Maia exposed the types of training algorithms and parameters available from a pandas-like API to the user as a GUI.
                ...
                to predict and the type of model to train and, much like the data processing service, Maia would spin up a mode training service based on the workload and perform the task.`,
        ...
        },
        {
            ...
            content: [
                `Because each process relied on severless, on-demand compute, users could upload as many separate sets of data and train as many models as they wanted in parallel.
        ...
        },
        {
            ...
            content: [
                `Users were able to specify access on their data and models to any other user in the platform.
        ...
        },
        {
            ...
            content: [
                `After users finished training their models, they could create an API endpoint to use to make predictions from outside the scope of the frontend application.
        ...
        },
        {
            ...
            content: [
                `Maia would tracked used compute for all tasks. It would use the time, cpu, and memory use to bill customers on a per second rate. However, the platform would also track
        ...
        },
        {
            ...
            content: [
                `I thought Maia was an incredible idea with a lot of potential. I loved allowing users to create full-blown, deployed machine learning models and APIs
