...
const Jobly: Page = {
    ...
    content: [
        {
            header: "Overview",
            content: `Jobly is a job search application that helps users find jobs that match their skills and interests.
        ...
        },
        {
            ...
            content: `I have hundreds of emails from recruiters. I took a sample of about 2500 emails from a 1 year window and fed them to Google's Vertex AI
        ...
        {
            header: "How It Works",
            content: `After creating the two AI models, I created a service that can index a user's email inbox. While indexing, emails would first get saved with additional metadata
