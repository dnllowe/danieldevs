...
const BGCInterprocessCommunication: Page = {
    ...
    content: [
        ...
        },
        {
            ...
            content: [
                `I used the chromium Broadcast Channel API to handle communication within the app. Our trading app comprised N number of tabs or windows. Tabs shared a process, but each window operated on its own separate processes.
