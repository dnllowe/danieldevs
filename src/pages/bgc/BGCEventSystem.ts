    ...
    content: [
        {
            header: "Use Case",
            content: [
                `We created the Event Notification System to allow users to customize the trading application to fit their needs and trading strategies.
        ...
        },
        {
            ...
            content: [
                `I used the chromium Broadcast Channel API to handle communication with the app. Our trading app comprised N number of tabs or windows. 
