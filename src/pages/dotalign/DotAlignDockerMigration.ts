...
const DotAlignDockerMigration: Page = {
    ...
    content: [
        ...
        {
            content: [`The native model had limitions, though. Different Outlook, Windows, and PC hardware versions led to unexpected bugs.
            User encountered performance issues when the plugin ran in their Outlook pane.
            And deploying required manual installation on each user's device, which made rolling out to large teams an obstacle.
        ...
        },
        {
            ...
            content: [
                `DotAlign was a .NET WPF application. Certain coding decisions and patterns were
        ...
        },
        {
            ...
            create an Azure resource group, a container service resource, login to our Azure Docker Registry from your console, run the docker commands, then finally go about your dev work. Not. Fun.`]
        },
        {
            content: [`After doing this one-too-many times one weekend while working on bug fixes, I read up on the documentation for Azure Resources and discovered
            ...
            and turned what used to require 5 or so minutes of manual input and monitoring to a background task. Much better.`]
        },
        {
            ...
            created the user's deployment and service endpoint. I wrapped this logic into its own microservice and deployed it as a container.
            Once we had a long running internal production deployment, this REST endpoint replaced the Powershell script from before.`]
        },
        {
            ...
            This way, only authorized users could make API calls, and they could only makes calls to their Kubernetes pods`]
        },
        {
            ...
            the externally shared volume. Multiply this chatter by each user and... The bill. Is. High.`],
        },
        {
            content: [`Using Docker's infrastructure to our advantage, I was able to reduce the cost per user deployment
            ...
            as we wanted for free within the container's temporary local storage. The solution was to run the majority of DotAlign's tasks
            within the container. Then periodically, we save the user's local database to the shared location. 
            One operation instead 100s of 1000s. Problem solved.`],
            img: {
                url: "https://i.imgflip.com/9cqe1k.jpg",
                caption: "The Azure bill is too high meme"
            }
        },
        {
