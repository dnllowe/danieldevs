...
const DotAlignAzureFunction: Page = {
    ...
    keywords: ['dotalign', 'work experience', 'faas', 'microservice', 'micro service', 'serverless', 'backend'],
    ...
    image: {
        ...
        caption: 'The Azure Functions logo. Not to be confused with The Flash symbol.',
    ...
    content: [
        {
            header: 'Overview',
            content: [
                `DotAlign was once a native Windows application installed as an Outlook addin.
        ...
        },
        {
            ...
            content: [
                `Indexing and analyzing email is at the core of what DotAlign does. To accomplish this
                in a cloud setting, I used the Microsoft Graph REST API. First, the web application places a 
                message on a queue for the indexing microservice.`,
            ]
        },
        {
        ...
        {
            header: 'Using a dedicated micro service for indexing',
            content: [
                `I was able to drastically improve the time it takes
        ...
        },
        {
            ...
            content: [
                `When working with Azure Functions, much of the logic for how functions interact
        ...
        },
        {
            ...
            content: [
                `When a DotAlign instance begins, we seed the database with information on well-known
