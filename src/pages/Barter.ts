    ...
    content: [
        {
            ...
            content: [
                `Although I was eager to try native development with Swift and Java on iOS and Android,
        ...
        },
        {
            ...
            content: [
                `The data model for Barter had many related entities: users, the items they owned,
        ...
        },
        {
            ...
            content: [
                `I've used dedicated web servers and docker containers for backends in the past.
        ...
        },
        {
            ...
            content: [
                `Using GraphQL with a Neo4j graph database made the backend code almost non-existent. 
                ...
                everything comes from the schema, and there's only one endpoint. 
                Less code and boilerplate. More time developing features. 
                I definitely want to use GraphQL more in the future.`
            ]
        },
        {
            header: "Apollo on the Frontend",
            content: [
                `I use Apollo on the frontend to interact with the API in React.
