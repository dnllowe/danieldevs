    ...
    content: [
        {
            header: "Game Design",
            content: [
                `Route Way is a prototype for a cozy management game about creating bus routes for a town.
        ...
        },
        {
            ...
            content: [
                `One of the key aspects of the game was giving players an infinite sandbox to experiment in.
        ...
        },
        {
            ...
            content: [
                `My performance target for procedural generation was to be able to generate an entire region within a second. Because I was generating dozens of roads
        ...
        },
        {
            header: "Pathfinding",
            content: [
                `I made use of A* pathfinding to automatically create logical preview paths when players moved the cursor around
