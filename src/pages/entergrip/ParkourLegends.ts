import ParkourLegendsFinalTrailer from '../../components/ParkourLegendsFinalTrailer'
import ParkourLegendsTrailer5 from '../../components/ParkourLegendsTrailer5'
...
const ParkourLegends: Page = {
    ...
    content: [
        {
            content: [],
            component: ParkourLegendsTrailer5
        },
        {
            header: "Game Design",
            content: [
                `Parkour Legends is a twist on the traditional 2d platformer formula. Instead of fighting enemies,
        ...
        },
        {
            ...
            content: [
                `At first glance, beating the levels is a straightforward task once players have learned the controls.
        ...
        },
        {
            header: "Art",
            content: [
                `Parkour Legends is painstakingly animated by hand. Each and every pixel of every animation was hand drawn by me.
        ...
        },
        {
            header: "Tech",
            content: [
                `I built Parkour Legends using Unity and C#. Most functionality is broken up into Systems that act on the plauyer based on the player's state.
        ...
        },
        {
            header: "Replays",
            content: [
                `There are many fascinating aspects to every game, but perhaps one of the bigger "wow" factors for both players and the technical implementation is the Replay system.
        ...
        },
        {
            ...
            content: [
                `To complete a full-length game as a solo dev in 18 months, you have to keep productivity high. To maximize my efforts, I created several scripts, tools, and custom Unity editors to speed up time-consuming tasks.`,
        ...
        {
            content: [],
            component: ParkourLegendsFinalTrailer,
            relatedPages: [
                {
