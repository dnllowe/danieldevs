import BurgerFlipperTrailer from '../../components/BurgerFlipperTrailer'
...
const BurgerFlipper: Page = {
    ...
    content: [
        {
            content: [],
            component: BurgerFlipperTrailer,
        },
        {
            header: "Game Design",
            content: [
                `Burger Flipper is a fast food management simulation prototype I made in Unreal Engine.
        ...
        },
        {
            ...
            content: [
                `I became very comfortable with Blueprints,
        ...
        },
        {
            ...
            content: [
                `Though I started with Unreal Engine 5, I found that the Chaos Physics system wasn't tuned quite right for have many,
